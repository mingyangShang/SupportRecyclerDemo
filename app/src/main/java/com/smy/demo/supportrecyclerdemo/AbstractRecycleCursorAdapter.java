...
public abstract class AbstractRecycleCursorAdapter extends SupportRecyclerView.SupportAdapter
     ...
     */
    public abstract void onBindViewHolder(SupportRecyclerView.SupportViewHolder holder, Cursor cursor);
     ...
     */
    public AbstractRecycleCursorAdapter(Context context, Cursor c) {
    ...
    @Override
    public void onBindViewHolder(SupportRecyclerView.SupportViewHolder holder, int position) {
        if (!mDataValid) {
    ...
    private class ChangeObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            Log.e("smy","change observer onChange");
            onContentChanged();
        }
    }
